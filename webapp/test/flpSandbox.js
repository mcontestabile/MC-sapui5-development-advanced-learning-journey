		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#studentcomsaptrainingux402listdetailux402listdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentcomsaptrainingux402listdetailux402listdetail-display": {
								"semanticObject": "studentcomsaptrainingux402listdetailux402listdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student.com.sap.training.ux402.listdetail.ux402listdetail",
									"url": sap.ui.require.toUrl("student/com/sap/training/ux402/listdetail/ux402listdetail")
								}
							}
						}
					}
